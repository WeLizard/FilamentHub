...
>
> Аудит безопасности и баги (P0–P3): [`TODO.md`](TODO.md)
...
- [x] Добавить endpoint `/api/v1/auth/logout` (blacklist токенов)
...
- [x] **Двусторонняя синхронизация (OrcaSlicer → FilamentHub)** (частично - filament presets):
  ...
  - [x] C++ Panel: Реализовать функцию `export_profiles_to_filamenthub()` для экспорта всех 3 типов профилей
