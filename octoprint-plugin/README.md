...
identifiers. The same synchronized snapshot is shown as a compact, read-only
spool list in OctoPrint's sidebar, with the currently selected slot highlighted.
