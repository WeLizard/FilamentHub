...
| [`docs/PENDING_TASKS.md`](docs/PENDING_TASKS.md) | Нерешённые задачи, Issues, вендор-бандлы |
| [`docs/OrcaSlicer/TODO.md`](docs/OrcaSlicer/TODO.md) | Профили OrcaSlicer: filament/print/printer/bundles |
