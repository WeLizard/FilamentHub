...
import { GoogleOAuthIcon, YandexOAuthIcon } from './serviceIcons';
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="fh-dark-autofill w-full pl-10 pr-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="fh-dark-autofill w-full pl-10 pr-12 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className={`fh-dark-autofill w-full pl-10 pr-12 py-3 bg-white/10 border rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all ${
              ...
              <div className="flex gap-2">
                ...
                >
                  {oauthLoading === 'google' ? (
                    ...
                    <GoogleOAuthIcon className="w-4 h-4 flex-shrink-0" />
                  )}
                  <span>Google</span>
                </button>
                )}
                ...
                >
                  {oauthLoading === 'yandex' ? (
                    ...
                    <YandexOAuthIcon className="w-4 h-4 flex-shrink-0" />
                  )}
