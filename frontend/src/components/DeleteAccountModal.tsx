...
export const DeleteAccountModal: React.FC<DeleteAccountModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <ModalOverlay onClose={onClose} className="!bg-black/75">
      {/* Modal */}
      <div className="relative w-full max-w-2xl max-h-[90vh] glass-panel rounded-2xl border border-white/20 shadow-xl overflow-hidden flex flex-col" onClick={(e) => e.stopPropagation()}>
        {/* Header */}
