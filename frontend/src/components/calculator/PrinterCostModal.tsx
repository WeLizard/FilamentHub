...
export const PrinterCostModal: React.FC<PrinterCostModalProps> = ({
  ...
  return (
    <ModalOverlay onClose={onClose}>
      <div className="max-h-[85vh] w-full max-w-lg overflow-hidden rounded-2xl border border-white/20 bg-gray-900">
        <div className="scrollbar-contained max-h-[calc(85vh-2px)] overflow-y-auto p-6">
          <div>
