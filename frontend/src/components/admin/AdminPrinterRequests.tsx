    ...
    if (!isNotFound) {
      return (
        <div className="text-center py-12">
          <div className="text-red-400 mb-2">Ошибка загрузки заявок</div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-white mb-2">Заявки на добавление принтеров</h2>
      ...
      {data && data.total > 20 && (
        <div className="flex items-center justify-center space-x-2">
          ...
          <span className="text-gray-400">Страница {page}</span>
          <button
          ...
          <div className="bg-gradient-to-br from-purple-900 to-indigo-900 rounded-2xl max-w-3xl w-full max-h-[90vh] overflow-hidden flex flex-col border border-white/20">
            ...
            <div className="flex-1 overflow-y-auto p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="text-gray-400 text-sm mb-1">Название принтера</p>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="text-gray-400 text-sm mb-1">Производитель</p>
                  <p className="text-white">{selectedRequest.manufacturer}</p>
                </div>
                <div>
                  <p className="text-gray-400 text-sm mb-1">Модель</p>
              ...
              {(selectedRequest.build_volume_x || selectedRequest.build_volume_y || selectedRequest.build_volume_z) && (
                <div>
                  <p className="text-gray-400 text-sm mb-1">Объём печати</p>
                  <p className="text-white">
                    {selectedRequest.build_volume_x || '?'} × {selectedRequest.build_volume_y || '?'} × {selectedRequest.build_volume_z || '?'} мм
                  </p>
                </div>
              )}
              ...
              {selectedRequest.message && (
                <div>
                  <p className="text-gray-400 text-sm mb-1">Дополнительная информация</p>
              ...
              <div className="text-sm text-gray-400 space-y-1">
                <p>{selectedRequest.user_email ? `Пользователь: ${selectedRequest.user_email}` : `Пользователь ID: ${selectedRequest.user_id}`}</p>
            ...
            {selectedRequest.status === 'pending' && (
              <div className="space-y-4">
                <div>
                  <label className="block text-gray-300 mb-2">Причина отклонения (если отклоняете)</label>
                  <textarea
                ...
                <div className="flex items-center justify-end space-x-3">
                  <button
                    onClick={() => {
                      if (confirm('Одобрить эту заявку? Принтер будет автоматически создан в базе.')) {
