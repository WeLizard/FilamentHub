...
export const HSLColorPicker: React.FC<HSLColorPickerProps> = ({
  ...
  return (
    <div className="relative">
      ...
      <div
        ref={flyoutRef}
        className={`hsl-color-picker-flyout absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-60 bg-gray-900 border border-white/20 rounded-xl shadow-2xl z-50 transition-all duration-300 ${
          isOpen
