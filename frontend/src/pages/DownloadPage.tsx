    ...
    <div className="max-w-5xl mx-auto px-6 py-12">
      ...
      <div className="text-center mb-12">
        <div className="flex items-center justify-center gap-3 mb-4">
          ...
          <h1 className="text-4xl font-bold text-white">OrcaSlicer FilamentHub Edition</h1>
        </div>
        <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-4">
          Единственная версия OrcaSlicer с интегрированным каталогом материалов — всё, что нужно для идеальной печати, в одном месте
        </p>
                 <div className="inline-flex items-center gap-2 px-4 py-2 bg-purple-600/20 border border-purple-500/30 rounded-lg text-purple-300 text-sm">
                 <Zap className="w-4 h-4" />
                 <span>Уникальная интеграция — только у нас!</span>
               </div>
      </div>
               ...
               <div className="grid grid-cols-3 gap-4 mb-6">
                 <button
                   onClick={() => {
                     ...
                     setSelectedArch('x64'); // Windows обычно x64
                   }}
