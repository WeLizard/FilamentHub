...
ORCA_SCALAR_FIELDS: dict[str, frozenset[str]] = {
    ...
    "host_type", "inherits", "is_artillery", "is_custom_defined", "is_support_3mf", "is_support_air_condition",
    ...
    "enable_extra_bridge_layer", "enable_mixed_color_sublayer", "enable_prime_tower", "enable_support",
