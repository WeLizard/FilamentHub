...
ORCA_PRESET_FIELDS: dict[str, frozenset[str]] = {
    "filament": frozenset(
        {
            # Reviewed profile metadata / plugin manifest fields. They remain
            # opaque passthrough and are not editable material data.
            "_comment",
            "filament_colour",
            "is_custom_defined",
            "plugins",
    ...
    "process": frozenset(
        {
            # Reviewed forward-compatible Orca and vendor extension fields.
            # Supported controls are surfaced by the process editor; plugin
            # and vendor metadata remains lossless opaque passthrough.
