...
- [ ] CreatePresetModal — 4320 строк, сотни хардкодов (крупнейшая задача)
- [ ] CreatePrinterProfileModal — placeholders, labels
- [ ] ProfilePage — labels, titles, actions
- [ ] BrandProfilePage — labels, titles
- [ ] AdminUsers — titles, confirmText
- [ ] TermsPage — юридический текст (оставить на потом)
